...
class VehicleDecision():
    ...
    def calc_normal(self, curr, prev):
        ...
        perp_left_factor*=0.75
        perp_right_factor*=0.75
...
class VehicleController():
    ...
    def execute(self, currentPose, targetPose, planner, lane_marker):
        ...
        print("Steering angle Pure Pursuit + RRT: ", targetPose[3])

        if target_v > 0:
            # v = xError * k_s + vError * k_ds
            v = 15 + 1/(k_speed*pp_steer + 1/40)
            #Send computed control input to vehicle
            newAckermannCmd = AckermannDrive()
            newAckermannCmd.speed = v*0.1
...
class Controller(object):
    ...
    def __init__(self):
        ...
        self.planner = PurePursuitPlanner(3)
